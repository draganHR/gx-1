**[Index](index.md) → [Effects](Effects.md) → [Delay](Effects%20-%20Delay.md) → Twist**

# Twist

![](../Images/png/91951371__Web.png)
...
| FALL TIME \*1 | 0–100 | Adjusts the time it takes for the rotation effect to stop when MODE changes from RISE to FALL. |
| FADE TIME \*2 | 0–100 | Adjusts the fade out time required when MODE changes from RISE to FADE. |

1. 1 Setting available when MODE is set to RISEÓFALL.
2. 2 Setting available when MODE is set to RISEÓFADE.